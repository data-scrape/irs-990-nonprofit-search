...
**Irs990Nonprofitsearch** — Scrape irs 990 nonprofit search data

![Python](https://img.shields.io/badge/Python-3.9+-blue?logo=python&logoColor=white)
![License](https://img.shields.io/badge/License-MIT-green?logo=opensourceinitiative&logoColor=white)
![Stars](https://img.shields.io/github/stars/data-scrape/irs-990-nonprofit-search?style=social)

</div>

> **Search intent:** collect public irs-990-nonprofit-search data for research, enrichment, and monitoring workflows. Related topics: web scraping, python, data extraction, scraper.

## What this project is for

`irs-990-nonprofit-search` is an implementation-focused Python project for collecting public irs-990-nonprofit-search data. It is designed around one practical job: turn a query such as **"restaurants in Seattle"** into structured records you can inspect, export, and pass into an automation workflow.
...
```bash
git clone https://github.com/data-scrape/irs-990-nonprofit-search.git
cd irs-990-nonprofit-search
...
```json
{
  ...
  "result": {
    ...
    "metadata": {"platform": "irs-990-nonprofit-search", "category": "Custom Scrapers"}
  }
}
```
